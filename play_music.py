...
import systems
import wavelink
from wavelink import Player, tracks

logger = systems.logging.getLogger(__name__)
...
class MusicBot(commands.Cog):
    ...
    @commands.Cog.listener()
    async def on_wavelink_track_start(self, player: wavelink.Player, track: wavelink.tracks):
